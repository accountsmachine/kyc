...
mappings = {
    ...
    'appoint-judicial-factor-with-name-date' : "**Appointment** of {officer_name} as a judicial factor on {appointment_date}",
    'appoint-judicial-factor-with-name' : "**Appointment** of {officer_name} as a judicial factor",
    ...
    'formation-european-economic-interest-groups-official-address-outside-uk' : "**Formation** of Economic Interest Group on {incorporation_date} whose official address is outside of the UK",
    ...
    'formation-terms-conversion-societas-europaea-to-public-limited-company' : "**Draft terms of conversion** to Public Limited Company",
    ...
    'conversion-societas-europaea-to-public-limited-company' : "**Conversion to Public Limited Company**",
    ...
    'elect-to-keep-the-directors-register-information-on-the-public-register' : "**Elect** to keep the directors' register information on the public register",
    'elect-to-keep-the-directors-residential-address-register-information-on-the-public-register' : "**Elect** to keep the directors' residential address register information on the public register",
    'elect-to-keep-the-secretaries-register-information-on-the-public-register' : "**Elect** to keep the secretaries register information on the public register",
    'elect-to-keep-the-persons-with-significant-control-register-information-on-the-public-register' : "**Elect** to keep the persons' with significant control register information on the public register",
    'elect-to-keep-the-members-register-information-on-the-public-register' : "**Elect** to keep the members' register information on the public register",
    'update-to-the-members-register-information-on-the-public-register' : "**Update** to the members' register information on the public register",
    'withdrawal-of-the-directors-register-information-from-the-public-register' : "**Withdrawal** of the directors' register information from the public register",
    'withdrawal-of-the-directors-residential-address-register-information-from-the-public-register' : "**Withdrawal** of the directors' residential address register information from the public register",
    'withdrawal-of-the-secretaries-register-information-from-the-public-register' : "**Withdrawal** of the secretaries register information from the public register",
    'withdrawal-of-the-persons-with-significant-control-register-information-from-the-public-register' : "**Withdrawal** of the persons' with significant control register information from the public register",
    'withdrawal-of-the-members-register-information-from-the-public-register' : "**Withdrawal** of the members' register information from the public register",
    'elect-to-keep-the-limited-liability-partnership-members-register-information-on-the-public-register' : "**Elect** to keep the members' register information on the public register",
    'elect-to-keep-the-limited-liability-partnership-members-residential-address-register-information-on-the-public-register' : "**Elect** to keep the members' residential address register information on the public register",
    'elect-to-keep-the-limited-liability-partnership-persons-with-significant-control-register-information-on-the-public-register' : "**Elect** to keep the persons' with significant control register information on the public register",
    'withdrawal-of-the-limited-liability-partnership-members-register-information-from-the-public-register' : "**Withdrawal** of the members' register information from the public register",
    'withdrawal-of-the-limited-liability-partnership-members-residential-address-register-information-from-the-public-register' : "**Withdrawal** of the members' residential address register information from the public register",
    'withdrawal-of-the-limited-liability-partnership-persons-with-significant-control-register-information-from-the-public-register' : "**Withdrawal** of the persons' with significant control register information from the public register",
    'second-filing-of-director-appointment-with-name' : "**Second filing** for the appointment of {officer_name} as a director",
    'second-filing-of-secretary-appointment-with-name' : "**Second filing** for the appointment of {officer_name} as a secretary",
    'second-filing-of-change-of-director-details-with-name' : "**Second filing** to change the details of {officer_name} as a director",
    'second-filing-of-change-of-secretary-details-with-name' : "**Second filing** to change the details of {officer_name} as a secretary",
    'second-filing-of-director-termination-with-name' : "**Second filing** for the termination of {officer_name} as a director",
    'second-filing-of-secretary-termination-with-name' : "**Second filing** for the termination of {officer_name} as a secretary",
    'second-filing-of-annual-return-with-made-up-date' : "**Second filing** of the annual return made up to {made_up_date}",
    'second-filing-of-member-appointment-with-name' : "**Second filing** for the appointment of {officer_name} as a member",
    'second-filing-of-change-of-member-details-with-name' : "**Second filing** to change the details of {officer_name} as a member",
    'second-filing-of-member-termination-with-name' : "**Second filing** for the termination of {officer_name} as a member",
    'second-filing-notification-of-a-person-with-significant-control' : "**Second filing** for the notification of {psc_name} as a person with significant control",
    'second-filing-notification-of-a-person-with-significant-control-without-name-date' : "**Second filing** for the notification of a person with significant control",
    'second-filing-change-details-of-a-person-with-significant-control' : "**Second filing** to change the details of {psc_name} as a person with significant control",
    'second-filing-change-to-a-person-with-significant-control-without-name-date' : "**Second filing** to change the details for a person with significant control",
    'second-filing-cessation-of-a-person-with-significant-control' : "**Second filing** for the cessation of {psc_name} as a person with significant control",
    'second-filing-cessation-of-a-person-with-significant-control-without-name-date' : "**Second filing** for the cessation of a person with significant control",
    'second-filing-notification-of-a-person-with-significant-control-statement' : "**Second filing** for the notification of a person with significant control statement",
    'second-filing-withdrawal-of-a-person-with-significant-control-statement' : "**Second filing** for the withdrawal of a person with significant control statement",
    'second-filing-notification-of-a-person-with-significant-control-limited-liability-partnership' : "**Second filing** for the notification of {psc_name} as a person with significant control",
    'second-filing-change-details-of-a-person-with-significant-control-limited-liability-partnership' : "**Second filing** to change the details of {psc_name} as a person with significant control",
    'second-filing-cessation-of-a-person-with-significant-control-limited-liability-partnership' : "**Second filing** for the cessation of {psc_name} as a person with significant control",
    'second-filing-notification-of-a-person-with-significant-control-statement-limited-liability-partnership' : "**Second filing** for the notification of a person with significant control statement",
    'second-filing-withdrawal-of-a-person-with-significant-control-statement-limited-liability-partnership' : "**Second filing** for the withdrawal of a person with significant control statement",
    'second-filing-capital-cancellation-treasury-shares-with-date-currency-capital-figure' : "**Second filing** of statement of capital on {date}",
    'second-filing-capital-cancellation-treasury-shares-with-date-treasury-capital-figure' : "**Second filing** of cancellation of treasury shares. Treasury capital:",
    'second-filing-capital-allotment-shares' : "**Second filing** of a statement of capital following an allotment of shares on {date}",
    'second-filing-capital-alter-shares-consolidation-statement-of-capital' : "**Second filing** of consolidation of shares. Statement of capital on {date}",
    'second-filing-capital-alter-shares-consolidation' : "**Second filing** of consolidation of shares on {date}",
    'second-filing-capital-alter-shares-subdivision-statement-of-capital' : "**Second filing** of sub-division of shares. Statement of capital on {date}",
    'second-filing-capital-alter-shares-subdivision' : "**Second filing** of sub-division of shares on {date}",
    'second-filing-capital-alter-shares-redemption-statement-of-capital' : "**Second filing** of statement of capital on {date}",
    'second-filing-capital-alter-shares-redemption' : "**Second filing** of re-demption of shares on {date}",
    'second-filing-capital-alter-shares-reconversion-statement-of-capital' : "**Second filing** of re-conversion of shares. Statement of capital on {date}",
    'second-filing-capital-alter-shares-reconversion' : "**Second filing** of re-conversion of shares on {date}",
    'second-filing-capital-alter-shares-consolidation-subdivision-reconversion-statement-of-capital' : "**Second filing** of consolidation, sub-division and re-conversion of shares. Statement of capital on {date}",
    'second-filing-capital-alter-shares-consolidation-subdivision-reconversion' : "**Second filing** of consolidation, sub-division and re-conversion of shares on {date}",
    'second-filing-capital-alter-shares-consolidation-subdivision-statement-of-capital' : "**Second filing** of consolidation and sub-division of shares. Statement of capital on {date}",
    'second-filing-capital-alter-shares-consolidation-subdivision' : "**Second filing** of consolidation and sub-division of shares on {date}",
    'second-filing-capital-alter-shares-consolidation-reconversion-statement-of-capital' : "**Second filing** of consolidation and re-conversion of shares. Statement of capital on {date}",
    'second-filing-capital-alter-shares-consolidation-reconversion' : "**Second filing** of consolidation and re-conversion of shares on {date}",
    'second-filing-capital-alter-shares-subdivision-reconversion-statement-of-capital' : "**Second filing** of sub-division and re-conversion of shares. Statement of capital on {date}",
    'second-filing-capital-alter-shares-subdivision-reconversion' : "**Second filing** of sub-division and re-conversion of shares on {date}",
    'second-filing-capital-alter-shares' : "**Second filing** of notice of consolidation, sub-division, redemption of shares or re-conversion of stock into shares",
    'second-filing-capital-cancellation-shares' : "**Second filing** of cancellation of shares. Statement of capital on {date}",
    'second-filing-capital-cancellation-shares-by-plc' : "**Second filing** of cancellation of shares by a PLC. Statement of capital on {date}",
    'second-filing-capital-redomination-of-shares' : "**Second filing** of redenomination of shares. Statement of capital {date}",
    'second-filing-capital-reduction-of-capital-redomination' : "**Second filing** Reduction of capital following redenomination. Statement of capital on {date}",
    'notice-of-removal-of-a-director' : "**Notice of removal** of a director",
    'notice-of-removal-of-a-corporate-director' : "**Notice of removal** of a corporate director",
    'accounts-with-accounts-type-audited-abridged' : "**Audited abridged accounts** made up to {made_up_date}",
    'accounts-with-accounts-type-unaudited-abridged' : "**Unaudited abridged accounts** made up to {made_up_date}",
    'directors-register-information-on-withdrawal-from-the-public-register' : "**Directors' register** information at {date} on withdrawal from the public register",
    'directors-usual-residential-address-register-information-on-withdrawal-from-the-public-register' : "**Directors' usual residential address register** information at {date} on withdrawal from the public register on {date}",
    'secretaries-register-information-on-withdrawal-from-the-public-register' : "**Secretaries register** information at {date} on withdrawal from the public register",
    'persons-with-significant-control-register-information-on-withdrawal-from-the-public-register' : "**Persons' with significant control register** information at {date} on withdrawal from the public register",
    'members-register-information-on-withdrawal-from-the-public-register': "**Members register** information at {date} on withdrawal from the public register",
    'limited-liability-partnership-members-register-information-on-withdrawal-from-the-public-register' : "**Members' register** information at {date} on withdrawal from the public register",
    'limited-liability-partnership-members-usual-residential-address-register-information-on-withdrawal-from-the-public-register' : "**Members' usual residential address register** information at {date} on withdrawal from the public register",
    'limited-liability-partnership-persons-with-significant-control-register-information-on-withdrawal-from-the-public-register' : "**Persons' with significant control register** information at {date} on withdrawal from the public register",
    'confirmation-statement-with-no-updates' : "**Confirmation statement** made on {made_up_date} with no updates",
    'confirmation-statement-with-updates' : "**Confirmation statement** made on {made_up_date} with updates",
    'confirmation-statement-with-made-up-date' : "**Confirmation statement** made on {made_up_date}",
    'confirmation-statement' : "{original_description}",
    'second-filing-of-confirmation-statement-with-made-up-date' : "**Second filing** of Confirmation Statement dated {made_up_date}",
    'gazette-dissolved-statutory-instrument' : "**Final Gazette** dissolved by statutory instrument",
    'gazette-dissolved-liquidation' : "**Final Gazette** dissolved following liquidation",
    'registration-and-designation-as-a-private-fund-limited-partnership' : "**Registration and designation** as a Private Fund Limited Partnership",
    ...
    'selection-of-documents-registered-before-January-1987' : "A selection of documents registered before 1 January 1987",
    'selection-of-mortgage-documents-registered-before-January-1987' : "A selection of mortgage documents registered before 1 January 1987",
    'selection-of-annual-filings-registered-before-January-1987' : "A selection of accounts registered before 1 January 1987",
    ...
    'order-of-court-restructuring-plan-and-change-share-capital' : "**Restructuring Plan and change in share capital**",
